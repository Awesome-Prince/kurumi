                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         ...
                         InlineKeyboardButton(
                             text="My luv ❤",
                             url="https://telegram.me/Horimaya")
                    ], 
                     [
                         InlineKeyboardButton(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I Am Busy With My Boy Friend 😘🤭](https://telegra.ph/file/97f8731118bc43fd96086.mp4)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
